                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                if (isset($_POST['add'])) {
                                    ...
                                    $check = "SELECT * FROM room WHERE type = '$room' AND hostel_name = '$bed' AND room_no = '$room_no'";
                                    ...
                                    if ($data[0] > 1) {
                                        ...
                                        $sql = "INSERT INTO `room`( `type`, `hostel_name`,`room_no`,`status`,`price`) VALUES ('$room','$bed','$room_no','$place','$price')";
